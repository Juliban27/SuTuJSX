...
export const CarritoProvider = (props) => { //Forma de proveer el contexto, puede recibir props
    ...
    const updateItem = (id, newQuantity) => {
        ...
        const updatedCart = [...carrito] // Crear una copia del arreglo carrito
        updatedCart[indice].quantity = newQuantity // Modificar la cantidad en la copia
        setCarrito(updatedCart) // Actualizar el estado con la copia modificada
    }
